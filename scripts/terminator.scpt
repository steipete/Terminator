--------------------------------------------------------------------------------
-- terminator.scpt - v0.5.1 "T-800"
-- AppleScript: Improved logic to detect meaningful content in multi-line terminal buffers.
--              Addresses issues with lineIsEffectivelyEmptyAS on multi-line text.
--              Consistent scriptInfoPrefix usage.
--------------------------------------------------------------------------------
...
property tabTitlePrefix : "Terminator 🤖💥 " -- For the window/tab title itself
...
on usageText()
    ...
    set outText to scriptName & " - v0.5.1 \"T-800\" – AppleScript Terminal helper" & LF & LF
