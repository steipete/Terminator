...
describe('Swift Log Parser', () => {
    ...
    describe('parseAndLogSwiftOutput', () => {
        it('should parse and forward Swift log lines to pino', () => {
            const swiftLog = '[2025-06-10T12:53:20.123Z INFO ProcessResponsibility.swift:33 disclaimParentResponsibility()] Attempting to re-spawn as self-responsible process';
