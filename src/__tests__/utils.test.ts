...
describe('utils', () => {
    ...
    describe('expandTilde', () => {
        ...
        it('should handle tilde at the beginning only', () => {
            ...
            expect(expandTilde('~/Documents/~notexpanded')).toBe('/Users/testuser/Documents/~notexpanded');
        });
    ...
    describe('resolveEffectiveProjectPath', () => {
        ...
        it('should create non-existent directories', () => {
            ...
            expect(vi.mocked(fs.mkdirSync)).toHaveBeenCalledWith(newPath, { recursive: true });
        ...
        it('should create deeply nested directories', () => {
            ...
            expect(vi.mocked(fs.mkdirSync)).toHaveBeenCalledWith(deepPath, { recursive: true });
    ...
    describe('formatCliOutputForAI', () => {
        ...
        it('should handle timeout in output', () => {
            const result = { ...mockResult, stdout: 'Execution timed out after 30 seconds' };
        ...
        it('should handle list with multiple sessions', () => {
            const sessions = [
                ...
                { project_name: 'Project2', session_identifier: 'test', is_busy: false }
            ];
        ...
        it('should handle successful kill action', () => {
            const result = { ...mockResult, exitCode: 0, stdout: 'Process terminated' };
